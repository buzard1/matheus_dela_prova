...
//GARENTE QUE O USUARIO ESTEJA LOGADO
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if($nova_senha !== $confirmar_senha){
        ...
        echo "<script>alert('A senha dever ter pelo menos 8 caracteres!');</script>";
        ...
        if($stmt->execute()){
            ...
            echo "<script>alert('Senha altera com sucesso! Faça login novamente');window.location.href='login.php';</script>";
